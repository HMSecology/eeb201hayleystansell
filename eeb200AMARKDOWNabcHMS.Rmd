...
ratemu3<- 1e-3
snpnumber3<- rpois(1e6, tsplit3*ratemu3*2)
#snpnumber
max(snpnumber3)
length(snpnumber3)
...
#######careful! N is 100,000  .......don't know what the split population size is.... timesplit + simulated N (simulated with the rate)..... N generations is going to vary, THAT IS WHAT GOES INTO THE TIME TO COAL
```
